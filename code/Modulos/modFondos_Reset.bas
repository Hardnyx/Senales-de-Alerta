...
Public Sub CrearQueryFondos(ByVal rutaArchivo As String, ByVal arg2 As Variant, ByVal arg3 As Variant, _
    ...
    If Not IsMissing(arg4) Then
        If VarType(arg4) = vbBoolean Then
            activar = CBool(arg4)
            If Not IsMissing(arg5) Then
                If Len(Trim$(CStr(arg5))) > 0 Then entidadPrefix = UCase$(Trim$(CStr(arg5)))
            End If
            If Not IsMissing(arg6) Then showProg = CBool(arg6)
        Else
            If Len(Trim$(CStr(arg4))) > 0 Then entidadPrefix = UCase$(Trim$(CStr(arg4)))
            If Not IsMissing(arg5) Then showProg = CBool(arg5)
        End If
    End If
