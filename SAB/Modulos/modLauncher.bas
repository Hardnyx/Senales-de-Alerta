...
Private Function GetForm() As frmCargaSAB
    ...
    For Each uf In VBA.UserForms
        If TypeName(uf) = "frmCargaSAB" Then
            Set mForm = uf
            Set GetForm = mForm
            Exit Function
        End If
...
Public Sub ShowFormModal()
    ...
    ' Nota: EnableMinimizeBox debe llamarse en frmCargaSAB.UserForm_Activate
    f.Show vbModal
